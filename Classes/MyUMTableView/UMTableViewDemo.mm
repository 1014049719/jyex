...
- (void)viewDidLoad
{
    ...
    _mTableView =  [[UMUFPTableView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height-44) style:UITableViewStylePlain appkey:YOUMENG_APPKEY slotId:nil currentViewController:self];
