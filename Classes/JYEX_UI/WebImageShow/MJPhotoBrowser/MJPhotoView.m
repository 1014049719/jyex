...
- (void)hide
{
    ...
    objc_msgSend( self.parentVC, @selector(controlTS),nil );
    ...
    /*
     if( flag )
     {
     objc_msgSend( self.parentVC, @selector(resetScreen),nil );
     
     }
     else
     {
     objc_msgSend( self.parentVC, @selector(fullScreen),nil );
     }
    */
