...
+ (NSDictionary*)defaultFilterInfo
{
    ...
    if(defaultFilterInfo==nil){
        defaultFilterInfo =
        @{
          @"CLDefaultEmptyFilter"     : @{@"name":@"CLDefaultEmptyFilter",     @"title":@"无", @"version":@(0.0), @"dockedNum":@(0.0)},
          @"CLDefaultLinearFilter"    : @{@"name":@"CISRGBToneCurveToLinear",  @"title":@"线性",@"version":@(7.0), @"dockedNum":@(1.0)},
          @"CLDefaultVignetteFilter"  : @{@"name":@"CIVignetteEffect",         @"title":@"装饰图案", @"version":@(7.0), @"dockedNum":@(2.0)},
          @"CLDefaultInstantFilter"   : @{@"name":@"CIPhotoEffectInstant",     @"title":@"素描",   @"version":@(7.0), @"dockedNum":@(3.0)},
          @"CLDefaultProcessFilter"   : @{@"name":@"CIPhotoEffectProcess",     @"title":@"灰阶", @"version":@(7.0), @"dockedNum":@(4.0)},
          @"CLDefaultTransferFilter"  : @{@"name":@"CIPhotoEffectTransfer",    @"title":@"消噪",   @"version":@(7.0), @"dockedNum":@(5.0)},
          @"CLDefaultSepiaFilter"     : @{@"name":@"CISepiaTone",              @"title":@"老化",    @"version":@(5.0), @"dockedNum":@(6.0)},
          @"CLDefaultFilter"          : @{@"name":@"CIPhotoEffectChrome",      @"title":@"鉻黄",    @"version":@(7.0), @"dockedNum":@(7.0)},
          @"CLDefaultChromeFilter"    : @{@"name":@"CIPhotoEffectFade",        @"title":@"褪色",       @"version":@(7.0), @"dockedNum":@(8.0)},
          @"CLDefaultCurveFilter"     : @{@"name":@"CILinearToSRGBToneCurve",  @"title":@"光滑",      @"version":@(7.0), @"dockedNum":@(9.0)},
          @"CLDefaultTonalFilter"     : @{@"name":@"CIPhotoEffectTonal",       @"title":@"锐化",      @"version":@(7.0), @"dockedNum":@(10.0)},
          @"CLDefaultNoirFilter"      : @{@"name":@"CIPhotoEffectNoir",        @"title":@"黑白",       @"version":@(7.0), @"dockedNum":@(11.0)},
          @"CLDefaultMonoFilter"      : @{@"name":@"CIPhotoEffectMono",        @"title":@"低阶",       @"version":@(7.0), @"dockedNum":@(12.0)},
          @"CLDefaultInvertFilter"    : @{@"name":@"CIColorInvert",            @"title":@"反转",     @"version":@(6.0), @"dockedNum":@(13.0)},
          };
    }
