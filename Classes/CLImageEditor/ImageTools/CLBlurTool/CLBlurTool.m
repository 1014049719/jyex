...
- (void)setBlurMenu
{
    ...
    NSArray *_menu = @[
                       @{@"title":@"一般", @"icon":[NSString stringWithFormat:@"CLImageEditor.bundle/%@/icon_normal.png", [self class]]},
                       @{@"title":@"圆形", @"icon":[NSString stringWithFormat:@"CLImageEditor.bundle/%@/icon_circle.png", [self class]]},
                       @{@"title":@"条块", @"icon":[NSString stringWithFormat:@"CLImageEditor.bundle/%@/icon_band.png", [self class]]},
    ];
