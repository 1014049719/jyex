...
@implementation SelectFolderIcon
...
-(IBAction)OnFolderIcon:(id)sender
{
    ...
    NSString *strIcon;
    strIcon = [NSString stringWithFormat:@"%d",tag];
    
    if (msgParam != nil)
    {
		[msgParam.obsv performSelector:msgParam.callback withObject:strIcon afterDelay:0.0];
    }
