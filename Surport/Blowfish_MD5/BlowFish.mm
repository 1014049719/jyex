...
CBlowFish::CBlowFish(BYTE* ucKey, size_t keysize, const SBlock& roChain):m_oChain0(roChain),
    m_oChain(roChain)
{
    if (keysize < 1)
    {
...
inline void BytesToBlock(BYTE const* p, SBlock& b)
{
    unsigned int y;
...
inline void BlockToBytes(SBlock const& b, BYTE* p)
{
    unsigned int y;
...
void CBlowFish::Encrypt(BYTE* buf, size_t n, int iMode)
{
...
//Returns false if n is multiple of 8
void CBlowFish::Decrypt(BYTE* buf, size_t n, int iMode)
{
    //Check the buffer's length - should be > 0 and multiple of 8
    if ((n == 0) || (n % 8 != 0))
    {
...
//Returns false if n is multiple of 8
void CBlowFish::Encrypt(const BYTE* in, BYTE* out, size_t n, int iMode)
{
    //Check the buffer's length - should be > 0 and multiple of 8
    if ((n == 0) || (n % 8 != 0))
    {
...
//Returns false if n is multiple of 8
void CBlowFish::Decrypt(const BYTE* in, BYTE* out, size_t n, int iMode)
{
    //Check the buffer's length - should be > 0 and multiple of 8
    if ((n == 0) || (n % 8 != 0))
    {
